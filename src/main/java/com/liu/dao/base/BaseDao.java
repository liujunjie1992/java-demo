...
public interface BaseDao<T> {
	...
	public PageModel<Object> findByProperty(String property,String clazz,String whereHQL,List<Object> param,LinkedHashMap<String,String> orderby,int firestResutl,int maxResult) throws RuntimeException;
	/**
	 * 从数据库中查询相应列表(根据条件)
	 * @param whereHQL 查询条件
	 * @param hql 查询语句
	 ...
	 * @param hql 查询语句
	 * @param whereHQL 查询条件
	 * @param param List对象，条件查询的参数
	 * @param firstResult 从第几页开始查询
	 * @param maxResult 每页查询多少条数据
	 * @param orderby 排序 LinkedHashMap对象（"id","DESC"）
	 * @return PageModel对象
	 * @throws RuntimeException
	 */
	public PageModel<T> getScrollData(String hql,String whereHQL,List<Object> param,int firstResult,int maxResult,LinkedHashMap<String , String> orderby) throws RuntimeException ;
	public PageModel<T> getScrollData(String hql,String whereHQL,List<Object> param,int firstResult,int maxResult) throws RuntimeException ;
	public PageModel<T> getScrollData(String hql,int firstResult,int maxResult,LinkedHashMap<String , String> orderby) throws RuntimeException ;
