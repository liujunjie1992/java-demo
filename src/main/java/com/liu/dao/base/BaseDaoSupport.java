...
import com.liu.util.hiber.BaseQuery;
import com.liu.util.hiber.PageModel;
import com.liu.util.hiber.QueryUtil;
...
public class BaseDaoSupport<T> extends HibernateTemplateSupport<T> implements BaseDao<T> {
	...
	@Override
	public void deleteAllObject(final Class<T> entityName, final Object[] ids) throws RuntimeException {
	...
	@Override
	public List<Object> findByProperty(final String property, final String clazz, final String whereHQL,
			final List<Object> param) throws RuntimeException {
	...
	@Override
	public Object findSingleByProperty(final String property, final String clazz, final String whereHQL,
			final List<Object> param) throws RuntimeException {
	...
	@SuppressWarnings("unchecked")
	@Override
	public PageModel<Object> findByProperty(final String property, final String clazz, final String whereHQL,
			final List<Object> param, final LinkedHashMap<String, String> orderby, final int firestResutl,
			final int maxResult) throws RuntimeException {
		return (PageModel<Object>) this.getHiberanteTemplate().execute(new HibernateCallback<Object>() {
			...
			public Object doInHibernate(Session session) throws HibernateException {
				...
				Query query = session.createQuery(hql);
				setQueryParams(query, param);
				query.setFirstResult(firestResutl).setMaxResults(maxResult);
				resultList = query.list();
				pm.setResultList(resultList);
				if (null != resultList && resultList.size() > 0) {
					pm.setTotalRecord(QueryUtil.getListCount(session, hql, param));
				}
				return pm;
			}
		});
	...
	@SuppressWarnings("unchecked")
	@Override
	public T findSingleEntity(final String hql, final String whereHQL, final List<Object> param)
	...
	@SuppressWarnings("unchecked")
	public T findSingle(final String hql, final Object... param) throws RuntimeException {
	...
	@Override
	public Object executeHQL(final String hql, final String setHQL, final String whereHQL, final List<Object> param)
			throws RuntimeException {
	...
	@Override
	public Object executeHQL(final String hql, final String setHQL, final String whereHQL, final Object[] param)
			throws RuntimeException {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<T> find(final String hql, final String whereHQL, final List<Object> param,
	...
	@SuppressWarnings("unchecked")
	public List<T> find(final String hql, final Object... param) throws RuntimeException {
	...
	@SuppressWarnings("unchecked")
	public List<T> findPage(final String hql, final int firstReult, final int maxResult, final Object... param)
			throws RuntimeException {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<T> find(final String hql, final String whereHQL, final List<Object> param, final int firstReult,
	...
	@SuppressWarnings("unchecked")
	@Override
	public PageModel<T> getScrollData(final String hql, final String whereHQL, final List<Object> param,
			final int firstResult, final int maxResult, final LinkedHashMap<String, String> orderby)
			throws RuntimeException {

		return (PageModel<T>) getHiberanteTemplate().execute(new HibernateCallback<Object>() {
			...
			public Object doInHibernate(Session session) throws HibernateException {
				...
				if (null != resultList && resultList.size() > 0) {
					pm.setTotalRecord(
							QueryUtil.getListCount(session, hql + buildWhereHQL(whereHQL), param).intValue());
				}
				return pm;
			}
		});
	 ...
	 */
	@Override
	public PageModel<T> getScrollData(String hql, int firstResult, int maxResult,
			final LinkedHashMap<String, String> orderby) throws RuntimeException {
